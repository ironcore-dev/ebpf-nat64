...
#define NAT64_LOG_UINT_VALUE(VALUE) NAT64_LOG_ADD_UINT("value", VALUE)
...
#define NAT64_LOG_L3_PROTOCOL(VALUE) NAT64_LOG_ADD_INT("l3_protocol", VALUE)
...
#define NAT64_LOG_ICMP_CODE(VALUE) NAT64_LOG_ADD_UINT("icmp_code", VALUE)
